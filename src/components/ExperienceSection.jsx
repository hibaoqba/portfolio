...
function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-20 px-6 md:px-20 bg-gradient-to-b from-white to-blue-50">
      <h2 className="text-3xl font-bold mb-16 text-center text-black-600">
        {t("experience.title")}
      </h2>
