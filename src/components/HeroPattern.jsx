...
export default function HeroPattern({ variant = "tri-classic" }) {
  if (variant !== "tri-classic") return null;

  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 w-full h-full">
      <defs>
        <linearGradient id="aLight" gradientUnits="userSpaceOnUse" x1="0" x2="0" y1="0" y2="100%" gradientTransform="rotate(240)">
          <stop offset="0" stopColor="#FFFFFF" />
          <stop offset="1" stopColor="#FFFFFF" />
        </linearGradient>

        <pattern id="bLight" patternUnits="userSpaceOnUse" width="540" height="450" x="0" y="0" viewBox="0 0 1080 900">
          <g fillOpacity="0.03">
        ...
        <pattern id="bDark" patternUnits="userSpaceOnUse" width="540" height="450" x="0" y="0" viewBox="0 0 1080 900">
          <g fillOpacity="0.05">
            ...
            <polygon fill="#9290C3" points="810 750 720 900 900 900" />
            <polygon fill="#535C91" points="810 750 900 600 720 600" />
            <polygon fill="#9290C3" points="990 750 900 900 1080 900" />
            <polygon fill="#9290C3" points="180 0 90 150 270 150" />
            <polygon fill="#535C91" points="360 0 270 150 450 150" />
            <polygon fill="#9290C3" points="540 0 450 150 630 150" />
            <polygon fill="#1B1A55" points="900 0 810 150 990 150" />
            <polygon fill="#070F2B" points="0 300 -90 450 90 450" />
            <polygon fill="#9290C3" points="0 300 90 150 -90 150" />
            <polygon fill="#9290C3" points="180 300 90 450 270 450" />
            <polygon fill="#535C91" points="180 300 270 150 90 150" />
            <polygon fill="#070F2B" points="360 300 270 450 450 450" />
            <polygon fill="#9290C3" points="360 300 450 150 270 150" />
            <polygon fill="#535C91" points="540 300 450 450 630 450" />
            <polygon fill="#070F2B" points="540 300 630 150 450 150" />
            <polygon fill="#9290C3" points="720 300 630 450 810 450" />
            <polygon fill="#535C91" points="720 300 810 150 630 150" />
            <polygon fill="#9290C3" points="900 300 810 450 990 450" />
            <polygon fill="#535C91" points="900 300 990 150 810 150" />
            <polygon fill="#1B1A55" points="0 600 -90 750 90 750" />
            <polygon fill="#535C91" points="0 600 90 450 -90 450" />
            <polygon fill="#9290C3" points="180 600 90 750 270 750" />
            <polygon fill="#535C91" points="180 600 270 450 90 450" />
            <polygon fill="#535C91" points="360 600 270 750 450 750" />
            <polygon fill="#9290C3" points="360 600 450 450 270 450" />
            <polygon fill="#535C91" points="540 600 630 450 450 450" />
            <polygon fill="#070F2B" points="720 600 630 750 810 750" />
            <polygon fill="#9290C3" points="900 600 810 750 990 750" />
            <polygon fill="#070F2B" points="900 600 990 450 810 450" />
            <polygon fill="#9290C3" points="0 900 90 750 -90 750" />
            <polygon fill="#535C91" points="180 900 270 750 90 750" />
            <polygon fill="#9290C3" points="360 900 450 750 270 750" />
            <polygon fill="#9290C3" points="540 900 630 750 450 750" />
            <polygon fill="#9290C3" points="720 900 810 750 630 750" />
            <polygon fill="#070F2B" points="900 900 990 750 810 750" />
            <polygon fill="#070F2B" points="1080 300 990 450 1170 450" />
            <polygon fill="#9290C3" points="1080 300 1170 150 990 150" />
            <polygon fill="#070F2B" points="1080 600 990 750 1170 750" />
            <polygon fill="#535C91" points="1080 600 1170 450 990 450" />
            <polygon fill="#9290C3" points="1080 900 1170 750 990 750" />
          </g>
        </pattern>
      </defs>

      <g className="dark:hidden">
        <rect x="0" y="0" width="100%" height="100%" fill="url(#aLight)" />
        <rect x="0" y="0" width="100%" height="100%" fill="url(#bLight)" />
      </g>

      <g className="hidden dark:block">
        <rect x="0" y="0" width="100%" height="100%" fill="url(#aDark)" />
        <rect x="0" y="0" width="100%" height="100%" fill="url(#bDark)" />
      </g>
    </svg>
  );
}
